  ...
  useEffect(() => {
    const fetchPageDetail = async () => {
      try {
        ...
        // Konversi Array features kembali ke string untuk form edit (Model Kolaborasi)
        const parsedModels = content.models
          ? content.models.map((m: any) => ({
              ...m,
        ...
        reset({
          ...
          // Data Kolaborasi Sektoral
          collab_badge_text: content.badge_text || "",
          collab_hero_title: content.hero_title || "",
          collab_hero_subtitle: content.hero_subtitle || "",
          collab_hero_image: content.hero_image || "",
          collab_penjelasan_title: content.penjelasan_title || "",
          collab_penjelasan_teks: content.penjelasan_teks || "",
          collab_penjelasan_image: content.penjelasan_image || "",
          collab_benefit_title: content.benefit_title || "",
          collab_benefits: content.benefits || [],
          collab_cta_title: content.cta_title || "",
          collab_cta_text: content.cta_text || "",
          collab_cta_link: content.cta_link || "",

          // Data Model Kolaborasi
          model_hero_title: content.hero_title || "",
          model_hero_subtitle: content.hero_subtitle || "",
          model_hero_image: content.hero_image || "",
          model_detail_title: content.model_title || "",
          model_detail_subtitle: content.model_subtitle || "",
          model_items: parsedModels,
          model_perbandingan: content.perbandingan_features || [],
          model_alur_title: content.alur_title || "",
          model_alur_description: content.alur_description || "",
          model_alurs: content.alur || [],
          model_faqs: content.faqs || [],
          model_cta_title: content.cta_title || "",
          model_cta_text: content.cta_text || "",
          model_cta_link: content.cta_link || "",
        });
      } catch (error) {
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Perbarui informasi dan struktur halaman publik ini.
          </p>
        </div>
      </div>
              ...
              <CardContent className="p-8 space-y-8">
                <div className="space-y-3">
                  ...
                  <Input
                    ...
                    className="h-14 text-lg font-medium rounded-xl border-border"
                  />
                  {errors.title && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <div className="flex h-12">
                      ...
                      <Input
                        id="slug"
                        className="rounded-l-none rounded-r-xl h-full"
                  ...
                  <div className="space-y-3">
                    ...
                    <Select
                      ...
                      defaultValue={watch("template_name")}
                    >
